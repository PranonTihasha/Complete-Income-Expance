...
<div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <a href="{{ route('expance.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;">Add Expance</a>
                    <h4 class="card-title">Expance Add </h4>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @foreach($expance as $key => $item) 
                        
                        <tr>
                            <td> {{ $key+1}} </td>
                            <td> {{ $item->expance_from }} </td> 
                            <td> {{ $item->expance_amount }} </td> 
                            <td> {{ $item->bank }} </td> 
                            <td> {{ $item->date }} </td> 
